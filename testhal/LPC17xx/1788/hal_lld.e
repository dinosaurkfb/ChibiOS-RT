# 1 "../../../os/hal/platforms/LPC17xx/hal_lld.c"
# 1 "E:\\Dpan\\my_docs\\GCloud\\dev\\ChibiOS-RT\\testhal\\LPC17xx\\1768//"
# 1 "<command-line>"
# 1 "../../../os/hal/platforms/LPC17xx/hal_lld.c"
# 26 "../../../os/hal/platforms/LPC17xx/hal_lld.c"
...
# 27 "../../../os/hal/platforms/LPC17xx/hal_lld.c" 2
...
# 208 "../../../os/hal/include/hal.h"
  void halInit(void);
# 28 "../../../os/hal/platforms/LPC17xx/hal_lld.c" 2
# 58 "../../../os/hal/platforms/LPC17xx/hal_lld.c"
void hal_lld_init(void) {


  nvicSetSystemHandlerPriority(11, ((1 << 3) >> 1));
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (((100 * 8000000)/2)/5) / 1000 - 1;
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0;
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = (1UL << 2) |
                  (1UL << 0) |
                  (1UL << 1);
}
# 76 "../../../os/hal/platforms/LPC17xx/hal_lld.c"
void LPC17xx_clock_init(void) {


  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->FLASHCFG = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->FLASHCFG & ~(0x0000000F << 12)) | (3UL << 12);




  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->SCS = (1 << 5) | (0 << 4);
  while (!(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->SCS & (1 << 6)))
    ;




  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL0 = 0x55515155;
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 = 0x54555455;

  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKCFG = 5 - 1;

  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL = 1UL;




  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0CFG = ((2 - 1) << 16) | ((100/2) - 1);
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0FEED = 0xAA;
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0FEED = 0x55;
  while (!(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & (1UL << 26)))
      ;

  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0CON = 0x03;
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0FEED = 0xAA;
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0FEED = 0x55;
  while (!(((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT & ((1UL << 25) | (1UL << 24))))
        ;
# 143 "../../../os/hal/platforms/LPC17xx/hal_lld.c"
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP = (1 << 15) | (1 << 9);
