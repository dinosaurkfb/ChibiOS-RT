...
#endif //ifdef LPC177x_8x 
  __IO uint32_t CCLKCFG;                    /*!< Offset: 0x104 (R/W)  CPU Clock Selection Register */
  __IO uint32_t USBCLKCFG;                  /*!< Offset: 0x108 (R/W)  USB Clock Selection Register */
...
typedef struct
{
  __IO uint32_t CONSET;                 /*!< Offset: 0x000 cC Control Set Register (R/W) */
  __I  uint32_t STAT;                   /*!< Offset: 0x004 cC Status Register (R/ ) */
  __IO uint32_t DAT;                    /*!< Offset: 0x008 cC Data Register (R/W) */
  __IO uint32_t ADR0;                   /*!< Offset: 0x00C cC Slave Address Register 0 (R/W) */
  ...
  __O  uint32_t CONCLR;                 /*!< Offset: 0x018 cC Control Clear Register ( /W) */
  __IO uint32_t MMCTRL;                 /*!< Offset: 0x01C Monitor mode control register (R/W) */
  __IO uint32_t ADR1;                   /*!< Offset: 0x020 cC Slave Address Register 1 (R/W) */
  __IO uint32_t ADR2;                   /*!< Offset: 0x024 cC Slave Address Register 2 (R/W) */
  __IO uint32_t ADR3;                   /*!< Offset: 0x028 cC Slave Address Register 3 (R/W) */
  __I  uint32_t DATA_BUFFER;            /*!< Offset: 0x02C Data buffer register ( /W) */
  __IO uint32_t MASK0;                  /*!< Offset: 0x030 cC Slave address mask register 0 (R/W) */
  __IO uint32_t MASK1;                  /*!< Offset: 0x034 cC Slave address mask register 1 (R/W) */
  __IO uint32_t MASK2;                  /*!< Offset: 0x038 cC Slave address mask register 2 (R/W) */
  __IO uint32_t MASK3;                  /*!< Offset: 0x03C cC Slave address mask register 3 (R/W) */
} LPC_I2C_TypeDef;
